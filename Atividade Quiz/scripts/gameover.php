...
$correct_answers = $_SESSION['game']['correct_answers'];  // Número de respostas corretas definidas no jogo.
$incorrect_answers = $_SESSION['game']['incorrect_answers'];  // Número de respostas erradas definidas no jogo.
?>
    ...
    <!-- Título principal do jogo (pode ser o mesmo nome de antes, como "Quiz das Capitais") -->
     ...
     <!-- Exibe o número total de questões jogadas com destaque para o valor -->
      ...
      <!-- Exibe o número de respostas corretas fornecidas pelo jogador, com destaque -->
       ...
       <!-- Exibe o número de respostas erradas fornecidas pelo joagor, com destaque -->
